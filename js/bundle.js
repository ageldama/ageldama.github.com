// ../../.cache/deno/npm/registry.npmjs.org/canvas-confetti/1.9.4/dist/confetti.module.mjs
var module = {};
...
function snow() {
  ...
  (function f() {
    ...
    confetti_module_default({
      ...
      gravity: randmimx(0.1, 0.2),
      scalar: randmimx(0.1, 0.2),
      drift: randmimx(-0.4, 0.4)
    });
    if (timeLeft > 0) {
...
function moneymoneymoney() {
  ...
  for (const e of emojis) {
    shapes.push(confetti_module_default.shapeFromText({
      text: e
    }));
  }
  (function frame() {
...
// js/all.mjs
window.letitsnow = snow;
window.moneymoneymoney = moneymoneymoney;
