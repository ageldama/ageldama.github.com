...
// ../../.cache/deno/npm/registry.npmjs.org/jquery/3.7.1/dist/jquery.js
var require_jquery = __commonJS({
  "../../.cache/deno/npm/registry.npmjs.org/jquery/3.7.1/dist/jquery.js"(exports, module3) {
    (function(global2, factory) {
      "use strict";
      if (typeof module3 === "object" && typeof module3.exports === "object") {
        module3.exports = global2.document ? factory(global2, true) : function(w) {
          if (!w.document) {
        ...
        makeArray: function(arr2, results) {
          ...
          if (arr2 != null) {
            if (isArrayLike(Object(arr2))) {
              jQuery.merge(ret, typeof arr2 === "string" ? [
                arr2
              ] : arr2);
            } else {
              push.call(ret, arr2);
      ...
      (function() {
        ...
        find.matchesSelector = function(elem, expr) {
          ...
          return find(expr, document3, null, [
            elem
          ]).length > 0;
        };
        ...
        function setMatcher(preFilter, selector, matcher, postFilter, postFinder, postSelector) {
          ...
          return markFunction(function(seed, results, context, xml) {
            var temp, i2, elem, matcherOut, preMap = [], postMap = [], preexisting = results.length, elems = seed || multipleContexts(selector || "*", context.nodeType ? [
              context
            ] : context, []), matcherIn = preFilter && (seed || !selector) ? condense(elems, preMap, preFilter, context, xml) : elems;
            if (matcher) {
      ...
      jQuery.extend({
        ...
        ready: function(wait) {
          ...
          readyList.resolveWith(document2, [
            jQuery
          ]);
        }
      });
      ...
      jQuery.fn.extend({
        ...
        html: function(value) {
          return access(this, function(value2) {
            ...
            if (typeof value2 === "string" && !rnoInnerhtml.test(value2) && !wrapMap[(rtagName.exec(value2) || [
              "",
              ""
            ])[1].toLowerCase()]) {
      ...
      var cssPrefixes = [
        ...
        "Moz",
        "ms"
      ], emptyStyle = document2.createElement("div").style, vendorProps = {};
      ...
      jQuery.each({
        ...
        jQuery.cssHooks[prefix + suffix] = {
          expand: function(value) {
            var i = 0, expanded = {}, parts = typeof value === "string" ? value.split(" ") : [
              value
            ];
            for (; i < 4; i++) {
...
// ../../.cache/deno/npm/registry.npmjs.org/lodash/4.17.21/lodash.js
var require_lodash = __commonJS({
  "../../.cache/deno/npm/registry.npmjs.org/lodash/4.17.21/lodash.js"(exports, module3) {
    (function() {
      var undefined2;
      var VERSION = "4.17.21";
...
// ../../.cache/deno/npm/registry.npmjs.org/mark.js/8.11.1/dist/mark.js
var require_mark = __commonJS({
  "../../.cache/deno/npm/registry.npmjs.org/mark.js/8.11.1/dist/mark.js"(exports, module3) {
    (function(global2, factory) {
      typeof exports === "object" && typeof module3 !== "undefined" ? module3.exports = factory() : typeof define === "function" && define.amd ? define(factory) : global2.Mark = factory();
    })(exports, function() {
      "use strict";
        ...
        ], [
          {
            ...
            value: function matches(element, selector) {
              var selectors = typeof selector === "string" ? [
                selector
              ] : selector, fn = element.matches || element.matchesSelector || element.msMatchesSelector || element.mozMatchesSelector || element.oMatchesSelector || element.webkitMatchesSelector;
              if (fn) {
                var match = false;
        ...
        createClass(Mark3, [
          ...
          },
          {
            ...
            value: function mark(sv, opt) {
              ...
              this.opt = opt;
              var totalMatches = 0, fn = "wrapMatches";
              var _getSeparatedKeywords = this.getSeparatedKeywords(typeof sv === "string" ? [
                sv
              ] : sv), kwArr = _getSeparatedKeywords.keywords, kwArrLen = _getSeparatedKeywords.length, sens = this.opt.caseSensitive ? "" : "i", handler = function handler2(kw) {
...
// ../../.cache/deno/npm/registry.npmjs.org/darkmode-js/1.5.7/lib/darkmode-js.js
var require_darkmode_js = __commonJS({
  "../../.cache/deno/npm/registry.npmjs.org/darkmode-js/1.5.7/lib/darkmode-js.js"(exports, module3) {
    (function webpackUniversalModuleDefinition(root, factory) {
      if (typeof exports === "object" && typeof module3 === "object") module3.exports = factory();
        ...
        function(modules) {
          ...
          "./src/index.js": (
            ...
            function(module4, exports2, __webpack_require__) {
              ...
              module4.exports = exports2["default"];
            }
          )
        })
      );
...
function resetSearchResults() {
  (0, import_jquery.default)(".search-results").empty();
  (0, import_jquery.default)(".search-loading-indicator").hide();
  (0, import_jquery.default)("main").fadeIn();
}
var showSearchResults_template = null;
function showSearchResults(searchTerm, searchResults) {
  (0, import_jquery.default)(".search-results").empty();
  (0, import_jquery.default)(".search-loading-indicator").hide();
  (0, import_jquery.default)("main").fadeOut();
  const $resultsContainer = (0, import_jquery.default)(".search-results");
  const templ = `
...
`;
  ...
  $resultsContainer.append((0, import_jquery.default)(expanded));
  const mark = new import_mark.default(document.querySelectorAll(".search-results"));
...
function executeSearch(searchTerm) {
  (0, import_jquery.default)(".search-loading-indicator").show();
  const ts = document.querySelector('meta[name="hugo-gen-timestamp"]').content;
  fetch("/index.json?" + String(ts)).then(function(response) {
    return response.json();
  }).then(function(data) {
    const filtered = _.filter(data, function(row) {
      return row && (searchTermMatch(searchTerm, row["title"]) || searchTermMatch(searchTerm, row["contents"]));
    });
    showSearchResults(searchTerm, filtered);
  });
}
(0, import_jquery.default)(function() {
  const $input = (0, import_jquery.default)("#search-query");
...
function addDarkmodeWidget() {
  var options = {
    ...
    time: "0.5s",
    mixColor: "#fff",
    ///backgroundColor: '#f6f5f3',  // default: '#fff'
    // NOTE magic number!
  ...
  var darkmode = new import_darkmode_js.default(options);
  window.darkmode = darkmode;
  (0, import_jquery2.default)(".dark-mode-btn").click(function() {
    dark_count++;
    if (dark_count === dark_hit) {
      splashText("show me the money!\u{1F4B2}");
      moneymoneymoney();
    } else {
      if (dark_count % 2 === 0) {
        splashCount(dark_count, dark_hit);
      }
      darkmode.toggle();
    }
  });
  (0, import_jquery2.default)(".snow-mode-btn").click(function() {
    if (!darkmode.isActivated()) {
      darkmode.toggle();
    }
    letitsnow();
    (0, import_jquery2.default)(".snow-mode-btn").prop("disabled", true);
  });
}
window.addEventListener("load", addDarkmodeWidget);
function splashCount(left, tot) {
  alert(`${left} / ${tot}`);
}
function splashText(txt) {
}
/*!
